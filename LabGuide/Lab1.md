...
. It contains the code segments for the labs and demos of this course. (**https://github.com/SPDoctor/M55613A_Allfiles**)
:::
...
6. [ ] Verify that the **Home** page appears in Microsoft Edge.
    ...
    ![Screenshot of home page](./Images/Lab1_Home_Final.png "Home page")
...
2. [ ] Verify that the **About** page appears and that the style of the **About** item in the menu bar changes to indicate that the **About** page has been selected.
    ...
    ![Screenshot](./Images/Lab1_About-Final.png "About page")

3. [ ] On the menu bar, click **Schedule**.

4. [ ] Verify that the **Schedule** page appears.

    ![Screenshot](./Images/Lab1_Schedule-Final.png "Schedule page")

5. [ ] In the box for the session named **Moving the Web forward with HTML5**, click the star icon.

    ::: warning
    **Note**: If a **This session is very popular! ...** dialog box appears, click **OK**.
    :::
...
8. [ ] Verify that the star turns grey/white and that the number of interested attendees decreases by one.
...
2. [ ] Verify that the **Register** page appears.
    ...
    ![Screenshot](./Images/Lab1_Register_Final.png "Register page")

3. [ ] Click **Register** and verify that all boxes except **Website/blog** are highlighted and that the **This is a required field** or equivalent message appears below the **First name** box.
...
15. [ ] Verify that the **Thanks for registering** confirmation page appears.
    ...
    ![Screenshot](./Images/Lab1_Registered_Final.png "Registered page")
...
5. [ ] Verify that the application displays your distance from the conference venue.
    ...
    ![Screenshot](./Images/Lab1_Location_Final.png "Location page")
...
2. [ ] Verify that the **Live** page appears.
     ...
     ![Screenshot](./Images/Lab1_Live_Final.png "Live page")
...
8. [ ] Verify that the **Feedback** page appears.
     ...
     ![Screenshot](./Images/Lab1_Feedback_Final.png "Feedback page")
...
#### Task 1: Explore the web pages for the application by using Visual Studio

1. [ ] In **ContosoConf - Microsoft Visual Studio**, in **Solution Explorer**, expand the **ContosoConf** project.
2. [ ] Double-click **wwwroot** to expand it and then double-click **index.htm**.
...
9. [ ] Verify that the following scripts are referenced:
    ...
    ```
10. [ ] In **Solution Explorer**, under **wwwroot**, double-click **about.htm**.
...
14. [ ] Verify that the **&lt;head&gt;** section includes the following link:
    ...
    ```
15. [ ] In **Solution Explorer**, under **wwwroot**, double-click **schedule.htm**.
...
19. [ ] In **Solution Explorer**, under **wwwroot**, double-click **register.htm**.
...
22. [ ] In **Solution Explorer**, under **wwwroot**, double-click **location.htm**.
...
28. [ ] In **Solution Explorer**, under **wwwroot**, double-click **live.htm**.
...
32. [ ] In **Solution Explorer**, under **wwwroot**, double-click **feedback.htm**.
...
1. [ ] In **Solution Explorer**, under **wwwroot**, expand the **images** folder, and then verify that it contains two subfolders with photographs of the conference speakers, and logos of conference sponsors.

2. [ ] Expand the **wwwroot/scripts** folder. This folder contains the JavaScript files used throughout the application. The **pages** subfolder contains the JavaScript files containing the code that is specific to each page. Each file is named after the corresponding HTML file.

3. [ ] Expand the **wwwroot/styles** folder. This folder contains the styles for the application. It is organized in a similar manner to the **scripts** folder. The **images** subfolder contains the graphic image of a star, used by the feedback and schedule pages.

#### Task 3: Run the application and make live modifications

1. [ ] In **Solution Explorer**, double-click **wwwroot/index.htm**.
...
::: success
**Results**: After completing this exercise, you will be able to describe how the Contoso Conference application is structured as a Visual Studio project.
:::
